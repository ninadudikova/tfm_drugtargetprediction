...
with open("03_results/resultados.txt", "a") as f:
    ...
    f.write(f"Precisión promedio:     {cv_results['test_precision'].mean():.4f}\n")
    f.write(f"Sensibilidad promedio:        {cv_results['test_recall'].mean():.4f}\n")
    f.write(f"Desviación estándar F1: {cv_results['test_f1'].std():.4f}\n")
    f.write("-" * 40 + "\n")
...
print(f"Sensibilidad promedio:        {cv_results['test_recall'].mean():.4f}")
print(f"Desviación estándar F1: {cv_results['test_f1'].std():.4f}")